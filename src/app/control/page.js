...
function ackStyle(ack) {
  if (ack === "OK") return "border-[#86efac] bg-[#f0fdf4] text-[#166534]";
  if (ack === "TIMEOUT") return "border-[#fcd34d] bg-[#fffbeb] text-[#92400e]";
  return "border-[#fca5a5] bg-[#fef2f2] text-[#991b1b]";
}

function actionStyle(state) {
  if (state === "active") return "border-[#bfdbfe] bg-[#eff6ff] text-[#1d4ed8]";
  if (state === "success") return "border-[#86efac] bg-[#f0fdf4] text-[#166534]";
  if (state === "error") return "border-[#fca5a5] bg-[#fef2f2] text-[#991b1b]";
    ...
    <main className={`${roboto.className} min-h-screen bg-[#f1f5f9] text-[#0f172a] antialiased`}>
      ...
      >
        ...
        <section className="rounded-2xl border border-[#e2e8f0] bg-white p-5 shadow-[0_4px_16px_rgba(15,23,42,0.06)]">
          ...
          <div className={`mx-auto w-full max-w-[280px] transition-opacity duration-200 ${isManual ? "opacity-100" : "opacity-25 pointer-events-none"}`}>
      ...
      >
        <div className="rounded-2xl border border-[#e2e8f0] bg-white p-5 shadow-[0_4px_16px_rgba(15,23,42,0.06)]">
          ...
          <div className="overflow-hidden rounded-xl border border-[#e2e8f0] bg-[#f8fafc] font-mono">
            <div className="grid grid-cols-[80px_1fr_90px] border-b border-[#e2e8f0] bg-white px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-[#94a3b8]">
              <span>Time</span>
              <span>Command</span>
              <span>ACK</span>
            </div>
