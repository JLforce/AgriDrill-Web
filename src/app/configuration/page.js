...
function mapPresetRowToForm(row) {
  return {
...
export default function ConfigurationPage() {
  ...
  const onApplyConfiguration = async (values) => {
    setLoading(true);
        ...
        <div className={`space-y-5 transition-all duration-700 delay-100 ${pageReady ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"}`}>
          ...
          <section className="rounded-3xl border border-[#d8e0ea] bg-white/90 p-5 shadow-[0_18px_36px_rgba(15,23,42,0.08)]">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Bed Length (m)</label>
                <input type="number" step="0.1" className={inputClassName} {...register("bedLengthM")} />
                {errors.bedLengthM ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.bedLengthM.message}</p> : null}
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Bed Width (m)</label>
                <input type="number" step="0.1" className={inputClassName} {...register("bedWidthM")} />
                {errors.bedWidthM ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.bedWidthM.message}</p> : null}
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Hole Spacing (cm)</label>
                <input type="number" step="1" className={inputClassName} {...register("holeSpacingCm")} />
                {errors.holeSpacingCm ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.holeSpacingCm.message}</p> : null}
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Drilling Depth (cm)</label>
                <input type="number" step="1" className={inputClassName} {...register("drillingDepthCm")} />
                {errors.drillingDepthCm ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.drillingDepthCm.message}</p> : null}
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Number of Rows</label>
                <input type="number" step="1" className={inputClassName} {...register("numberOfRows")} />
                {errors.numberOfRows ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.numberOfRows.message}</p> : null}
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Row Spacing (cm)</label>
                <input type="number" step="1" className={inputClassName} {...register("rowSpacingCm")} />
                {errors.rowSpacingCm ? <p className="mt-1 text-xs font-medium text-[#dc2626]">{errors.rowSpacingCm.message}</p> : null}
              </div>
              <div className="md:col-span-2">
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Crop Profile</label>
                <select className={inputClassName} {...register("cropProfile")}>
              ...
              <div className="md:col-span-2">
                <label className="mb-1.5 block text-sm font-semibold text-[#334155]">Notes (optional)</label>
                <textarea rows={4} className={inputClassName} {...register("notes")} />
