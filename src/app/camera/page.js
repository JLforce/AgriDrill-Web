  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_18%_20%,#1e3a8a_0%,transparent_35%),radial-gradient(circle_at_85%_12%,#0f766e_0%,transparent_30%),#030712] text-white">
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black pt-16">
        ...
        <div
          className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-[#0f172a] to-black"
          style={{
        ...
        {/* ── CONTROL BAR (Bottom) ────────────────────────────────── */}
        <div className="absolute bottom-0 left-0 right-0 z-20 border-t border-[#1f2937] bg-gradient-to-t from-black to-black/60 backdrop-blur-md">
