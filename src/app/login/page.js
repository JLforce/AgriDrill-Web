    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link href="/landing" className="inline-flex items-center justify-center gap-2">
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#16d39a]">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    id="remember"
                    name="remember"
                    className="h-4 w-4 rounded border-gray-300 text-[#16d39a] focus:ring-2 focus:ring-[#16d39a]/20"
                  />
                  <label htmlFor="remember" className="ml-2 text-sm text-gray-700">
                    Remember me
                  </label>
                </div>
                <Link href="#" className="text-sm font-medium text-[#16d39a] transition hover:text-[#12b684]">
                  Forgot password?
                </Link>
              </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link href="/signup" className="font-semibold text-[#16d39a] transition hover:text-[#12b684]">
            Sign up
          </Link>
        </p>
      </div>
